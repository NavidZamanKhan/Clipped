...
/// Reads plain text from the macOS system clipboard.
///
...
///
/// This is a simple struct with a single static function. There is no
/// need for a class or instance because we aren't storing any state —
/// we just reach into the system pasteboard, grab the text, and return it.
